...
<section class="orders">
   ...
   <div class="box-container">
      ...
      ?>
      <div class="box">
         <p> Invoice Number : <span><?php echo $fetch_orders['user_id']; ?></span> </p>
         <p> Issues on : <span><?php echo $fetch_orders['placed_on']; ?></span> </p>
         <p> Receiver name : <span><?php echo $fetch_orders['name']; ?></span> </p>
