...
if(isset($_POST['order_btn'])){
   ...
   $order_query = mysqli_query($conn, "SELECT * FROM `orders` WHERE name = '$Receiver_Name' AND number = '$Phone_Number' AND email = '$Email' AND method = '$Payment_Method' AND address = '$Shipping_Address' AND total_products = '$total_products' AND total_price = '$cart_total'") or die('query failed');
